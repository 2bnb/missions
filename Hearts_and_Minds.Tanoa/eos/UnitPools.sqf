...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["CFP_O_HAMAS_Sniper_01","CFP_O_HAMAS_Medic_01","CFP_O_HAMAS_Team_Leader_01","CFP_O_HAMAS_Rifleman_AT_01","CFP_O_HAMAS_Rifleman_AA_01","CFP_O_HAMAS_Grenadier_01","CFP_O_HAMAS_Machine_Gunner_01","CFP_O_HAMAS_Explosive_Specialist_01"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];
