...
private _allfaction = ["AFGCIV","CIV_F","BTC_AC","CAF_AG_AFR_CIV","CAF_AG_ME_CIV","CUP_C_RU","CUP_C_CHERNARUS","CUP_C_SAHRANI","CUP_C_TK","LIB_CIV","LOP_AFR_CIV","LOP_CHR_CIV","LOP_TAK_CIV","OPTRE_UEG_CIV","CIV_IDAP_F","RDS_RUS_CIV","UNSUNG_C"]; //All factions
...
switch (_p_en) do {
    /*case "Myfactionexemple" : {
	    ...
	    case "CFP_O_IS" : {
		btc_type_motorized= btc_type_motorized - ["cfp_o_is_BMP1","cfp_o_is_BMP1P","cfp_o_is_BMP2","cfp_o_is_BMP2_PKM","cfp_o_is_BMP2_ZU","cfp_o_is_BTR40_MG","cfp_o_is_BTR40_MG_flag","cfp_o_is_M113","cfp_o_is_ZSU","cfp_o_is_hmmwv_ags","cfp_o_is_hmmwv_dshkm","cfp_o_is_jeep_at","cfp_o_is_jeep_lmg","cfp_o_is_T72_flag","cfp_o_is_T72","cfp_o_is_T55","cfp_o_is_T34"];
        btc_type_motorized_armed= btc_type_motorized_armed - ["cfp_o_is_BMP1","cfp_o_is_BMP1P","cfp_o_is_BMP2","cfp_o_is_BMP2_PKM","cfp_o_is_BMP2_ZU","cfp_o_is_BTR40_MG","cfp_o_is_BTR40_MG_flag","cfp_o_is_M113","cfp_o_is_ZSU","cfp_o_is_hmmwv_ags","cfp_o_is_hmmwv_dshkm","cfp_o_is_jeep_at","cfp_o_is_jeep_lmg","cfp_o_is_T72_flag","cfp_o_is_T72","cfp_o_is_T55","cfp_o_is_T34"];
    };
