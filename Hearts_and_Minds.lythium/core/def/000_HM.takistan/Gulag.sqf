...
*/
AZM_bypass_list = ["76561198043024823",""];	
...
AZM_SLOTS = {
	...
	["76561198043024823", res1] call AZM_RESERVED_SLOT;
		...
		if (_slot == player) then {
			if ((getPlayerUID player) == _uidd || (getPlayerUID player) in AZM_bypass_list) then {
				...
				for "_sec" from 10 to 1 step -1 do {
					_kickvar = format ["<t size='3' color='#ff0000'>Goodbye... kicked in %1 !! <br/> %2</t>",_sec, name player];
